      ...
      <div className="container coaching-layout">
        <Reveal kind="scale" className="coaching-layout__visual">
          <div className="image-frame image-frame--portrait">
            <img
              src={COACHING_IMAGE}
              alt="Personas entrenando en Plaza Fitness bajo la instalación de luces hexagonales"
              loading="lazy"
            />
          </div>
          <div className="coaching-layout__index">
            02<span>/</span>03
          </div>
        </Reveal>
        <div className="coaching-layout__copy">
          ...
          <Reveal kind="mask" delay={0.08}>
            <h2>
              Tu cuerpo
              <br />
              <em>marca el ritmo.</em>
            </h2>
          </Reveal>
          <Reveal delay={0.16}>
            <p>
              No hay dos personas iguales. Por eso combinamos criterio técnico,
              atención cercana y un estímulo que se adapta a ti. Entrenar
              personalizado no es hacer más; es hacer lo que toca.
            </p>
          </Reveal>
