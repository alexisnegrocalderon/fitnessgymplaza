...
import { ADDRESS_LINE, SPACE_IMAGE } from "@/lib/gym-content";
    ...
    <section id="espacio" className="space-section section-bone">
      ...
      <div className="container space-layout">
        <div className="space-layout__copy">
          ...
          <Reveal delay={0.15}>
            <p>
              Acabamos de reabrir las puertas después de una remodelación
              completa. Nuevo equipamiento, mejor flujo y un espacio que está
              listo para acompañar tu próxima etapa.
            </p>
          </Reveal>
          <Reveal delay={0.2}>
            <div className="space-details">
              ...
              <div>
                <span>02</span>
                <strong>Más espacio de entrenamiento</strong>
              </div>
              <div>
                <span>03</span>
          ...
          <Reveal delay={0.25}>
            <a href="#contacto" className="text-link">
              Ven a conocerlo <ArrowRight size={16} />
            </a>
          </Reveal>
        </div>
        <Reveal kind="scale" delay={0.1} className="space-layout__visual">
          <div className="image-frame image-frame--large">
            <img
              src={SPACE_IMAGE}
              alt="Instalación de luces LED hexagonales sobre el piso de entrenamiento de Plaza Fitness"
              loading="lazy"
            />
            <div className="image-frame__caption">
